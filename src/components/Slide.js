...
const Slide = () => {
  ...
  const openNav = () => {
    setIsOpen(true);
    sideRef.current.style.width = "300px";
  };
    ...
    <div style={{ position: "absolute", top: "40px", left: "0px" }}>
      ...
      >
        <Stack
          ...
          sx={{ backgroundColor: "#000", p: "10px 0px" }}
        >
          <p style={{ color: "white" }}>Journey Boards</p>
          <WestIcon
            onClick={closeNav}
            sx={{
              backgroundColor: "#fff",
      ...
      <Card className="openbtn" sx={{ borderRadius: "0px 10px 10px 10px" }}>
        <Stack
          direction="row"
          alignItems="center"
          justifyContent="end"
          sx={{ backgroundColor: "#000", width: "100%", p: "10px 0px" }}
        >
          <EastIcon
            onClick={openNav}
            sx={{
        ...
        >
          <Typography variant="h5" sx={{ color: "blue", textAlign: "center" }}>
            1
          </Typography>
        </Stack>
      </Card>
